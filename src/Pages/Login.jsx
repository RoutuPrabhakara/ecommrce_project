            ...
            <div className="row">
                <div className="col-md-5 m-auto">
                    <div className="card p-3 shadow-sm">
                        ...
                        <input type="text" name="name"  id="email" className='form-control mb-2' placeholder='Enter  your Email'  required />

                        <label htmlFor="" className='form-label'>Password <span  className='text-danger'>*</span></label>
                        <input type="text" className='form-control' name ="email"  placeholder='Enter your Password' />
